...
@implementation customSegmentView24
...
- (void)drawRect:(CGRect)rect {
    ...
    self.layer.shadowOpacity 	= 0.03; 								// непрозрачность
    ...
    */
    ...
    self.layer.borderColor      = self.обводка.CGColor;
    self.layer.borderWidth      = self.толщина_обводки;
